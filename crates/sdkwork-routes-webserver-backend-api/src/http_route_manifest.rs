...
const HTTP_ROUTES: &[HttpRoute] = &[
    ...
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/backend/v3/api/clusters/{clusterId}",
        "cluster",
        "clusters.retrieve",
    ).with_required_permission("web.cluster.read"),
    HttpRoute::dual_token(
        ...
        "cluster",
        "clusters.update",
    ).with_required_permission("web.cluster.write").with_idempotent(true),
    HttpRoute::dual_token(
        HttpMethod::Delete,
        "/backend/v3/api/clusters/{clusterId}",
        "cluster",
    ...
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/backend/v3/api/clusters/hosts/{hostId}",
        "cluster",
        "clusters.hosts.retrieve",
    ).with_required_permission("web.cluster.read"),
    HttpRoute::dual_token(
        HttpMethod::Patch,
        "/backend/v3/api/clusters/hosts/{hostId}",
        "cluster",
        "clusters.hosts.update",
    ).with_required_permission("web.cluster.write").with_idempotent(true),
    HttpRoute::dual_token(
        HttpMethod::Delete,
        "/backend/v3/api/clusters/hosts/{hostId}",
        "cluster",
        "clusters.hosts.delete",
    ).with_required_permission("web.cluster.write").with_idempotent(true).with_rate_limit_tier(RateLimitTier::AuthCritical),
    HttpRoute::dual_token(
        HttpMethod::Get,
    ...
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/backend/v3/api/clusters/instances/{instanceId}",
        "cluster",
        "clusters.instances.retrieve",
    ).with_required_permission("web.cluster.read"),
    HttpRoute::dual_token(
        HttpMethod::Patch,
        "/backend/v3/api/clusters/instances/{instanceId}",
        "cluster",
        "clusters.instances.update",
    ).with_required_permission("web.cluster.write").with_idempotent(true),
    HttpRoute::dual_token(
        HttpMethod::Delete,
        "/backend/v3/api/clusters/instances/{instanceId}",
        "cluster",
        "clusters.instances.delete",
    ).with_required_permission("web.cluster.write").with_idempotent(true).with_rate_limit_tier(RateLimitTier::AuthCritical),
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/backend/v3/api/clusters/events",
        "cluster",
        "clusters.events.list",
    ).with_required_permission("web.cluster.read"),
    HttpRoute::dual_token(
        HttpMethod::Get,
        "/backend/v3/api/clusters/overview",
        "cluster",
        "clusters.overview.retrieve",
    ).with_required_permission("web.cluster.read"),
    HttpRoute::dual_token(
        HttpMethod::Get,
