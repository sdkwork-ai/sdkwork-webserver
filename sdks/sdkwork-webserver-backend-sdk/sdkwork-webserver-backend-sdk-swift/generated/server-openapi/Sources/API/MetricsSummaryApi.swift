...
public class MetricsSummaryApi {
    ...
    public func metricsSummariesRetrieve(dateFrom: String? = nil, dateTo: String? = nil) async throws -> MetricsSummariesRetrieveResponse? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/metrics_summaries"), query), responseType: MetricsSummariesRetrieveResponse.self)
    }

    /// Retrieve the dashboard metric summary of every tenant
    public func platformMetricsSummariesRetrieve(dateFrom: String? = nil, dateTo: String? = nil) async throws -> PlatformMetricsSummariesRetrieveResponse? {
        let query = buildQueryString([
            QueryParameterSpec(name: "date_from", value: dateFrom, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "date_to", value: dateTo, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/platform_metrics_summaries"), query), responseType: PlatformMetricsSummariesRetrieveResponse.self)
    }
