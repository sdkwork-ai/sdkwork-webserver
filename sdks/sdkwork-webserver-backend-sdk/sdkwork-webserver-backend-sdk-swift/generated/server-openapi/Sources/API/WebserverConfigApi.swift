...
public class WebserverConfigApi {
    ...
    public func webserverConfigsList() async throws -> WebserverConfigsListResponse? {
        return try await client.get(ApiPaths.backendPath("/webserver_configs"), responseType: WebserverConfigsListResponse.self)
    }

    /// Read one managed configuration file
    public func webserverConfigsRetrieve(configId: String) async throws -> WebserverConfigsRetrieveResponse? {
        return try await client.get(ApiPaths.backendPath("/webserver_configs/\(serializePathParameter(configId, PathParameterSpec(name: "configId", style: "simple", explode: false)))"), responseType: WebserverConfigsRetrieveResponse.self)
    }

    /// Validate and atomically overwrite one managed configuration file
    public func webserverConfigsUpdate(configId: String, body: WebserverConfigWriteRequest, idempotencyKey: String) async throws -> WebserverConfigsUpdateResponse? {
        ...
        return try await client.put(ApiPaths.backendPath("/webserver_configs/\(serializePathParameter(configId, PathParameterSpec(name: "configId", style: "simple", explode: false)))"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: WebserverConfigsUpdateResponse.self)
    }
