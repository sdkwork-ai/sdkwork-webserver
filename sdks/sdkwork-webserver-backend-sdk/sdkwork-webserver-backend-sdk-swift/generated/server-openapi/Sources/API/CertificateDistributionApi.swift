...
public class CertificateDistributionApi {
    ...
    public func certificatesDistributionList(page: Int? = nil, pageSize: Int? = nil) async throws -> CertificatesDistributionListResponse? {
        let query = buildQueryString([
            QueryParameterSpec(name: "page", value: page, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "page_size", value: pageSize, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/certificate_distribution"), query), responseType: CertificatesDistributionListResponse.self)
    }
