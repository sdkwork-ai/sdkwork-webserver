...
public class TrafficUsageApi {
    ...
    public func trafficUsagesRetrieve(dateFrom: String? = nil, dateTo: String? = nil, dimension: String? = nil, topApps: Int? = nil) async throws -> TrafficUsagesRetrieveResponse? {
        let query = buildQueryString([
            QueryParameterSpec(name: "date_from", value: dateFrom, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "date_to", value: dateTo, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "dimension", value: dimension, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "top_apps", value: topApps, style: "form", explode: true, allowReserved: false, contentType: nil)
        ])
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/traffic_usage"), query), responseType: TrafficUsagesRetrieveResponse.self)
    }

    /// Retrieve aggregated traffic usage of every tenant
    public func platformTrafficUsagesRetrieve(dateFrom: String? = nil, dateTo: String? = nil, dimension: String? = nil, topApps: Int? = nil) async throws -> PlatformTrafficUsagesRetrieveResponse? {
        let query = buildQueryString([
            QueryParameterSpec(name: "date_from", value: dateFrom, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "date_to", value: dateTo, style: "form", explode: true, allowReserved: false, contentType: nil),
            QueryParameterSpec(name: "dimension", value: dimension, style: "form", explode: true, allowReserved: false, contentType: nil),
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/platform_traffic_usage"), query), responseType: PlatformTrafficUsagesRetrieveResponse.self)
    }
