...
Gem::Specification.new do |spec|
  spec.name = 'sdkwork-webserver-backend-sdk'
  spec.version = Sdkwork::BackendSdk::VERSION
  spec.authors = ['SDKWork Team']
  spec.summary = 'sdkwork-webserver-backend-sdk Ruby SDK'
  spec.description = 'sdkwork-webserver-backend-sdk Ruby SDK'
  spec.license = 'MIT'
  spec.required_ruby_version = '>= 3.0'
  spec.files = Dir.glob('lib/**/*') + ['README.md', 'sdkwork-webserver-backend-sdk.gemspec']
