...
type TrafficUsageApi struct {
    client *sdkhttp.Client
}

func NewTrafficUsageApi(client *sdkhttp.Client) *TrafficUsageApi {
    return &TrafficUsageApi{client: client}
}

// Retrieve aggregated traffic usage of the caller's own tenant
func (a *TrafficUsageApi) TrafficUsagesRetrieve(dateFrom *string, dateTo *string, dimension *string, topApps *int) (sdktypes.TrafficUsagesRetrieveResponse, error) {
    query := BuildQueryString([]QueryParameterSpec{
        {Name: "date_from", Value: func() interface{} { if dateFrom == nil { return nil }; return *dateFrom }(), Style: "form", Explode: true, AllowReserved: false},
        {Name: "date_to", Value: func() interface{} { if dateTo == nil { return nil }; return *dateTo }(), Style: "form", Explode: true, AllowReserved: false},
        {Name: "dimension", Value: func() interface{} { if dimension == nil { return nil }; return *dimension }(), Style: "form", Explode: true, AllowReserved: false},
        {Name: "top_apps", Value: func() interface{} { if topApps == nil { return nil }; return *topApps }(), Style: "form", Explode: true, AllowReserved: false},
    })
    raw, err := a.client.Get(AppendQueryString(BackendApiPath("/traffic_usage"), query), nil, nil)
    if err != nil {
        var zero sdktypes.TrafficUsagesRetrieveResponse
        return zero, err
    }
    return decodeResult[sdktypes.TrafficUsagesRetrieveResponse](raw)
}

// Retrieve aggregated traffic usage of every tenant
func (a *TrafficUsageApi) PlatformTrafficUsagesRetrieve(dateFrom *string, dateTo *string, dimension *string, topApps *int) (sdktypes.PlatformTrafficUsagesRetrieveResponse, error) {
    query := BuildQueryString([]QueryParameterSpec{
        {Name: "date_from", Value: func() interface{} { if dateFrom == nil { return nil }; return *dateFrom }(), Style: "form", Explode: true, AllowReserved: false},
        {Name: "date_to", Value: func() interface{} { if dateTo == nil { return nil }; return *dateTo }(), Style: "form", Explode: true, AllowReserved: false},
        {Name: "dimension", Value: func() interface{} { if dimension == nil { return nil }; return *dimension }(), Style: "form", Explode: true, AllowReserved: false},
    ...
    raw, err := a.client.Get(AppendQueryString(BackendApiPath("/platform_traffic_usage"), query), nil, nil)
    if err != nil {
        var zero sdktypes.PlatformTrafficUsagesRetrieveResponse
        return zero, err
    }
    return decodeResult[sdktypes.PlatformTrafficUsagesRetrieveResponse](raw)
}
