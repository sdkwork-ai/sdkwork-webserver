...
func (a *ApplicationApi) ApplicationsList(page *int, pageSize *int, applicationType *string, siteType *int, status *int, q *string) (sdktypes.ApplicationsListResponse, error) {
