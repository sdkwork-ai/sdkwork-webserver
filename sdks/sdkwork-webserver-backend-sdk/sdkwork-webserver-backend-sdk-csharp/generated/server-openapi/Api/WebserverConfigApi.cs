...
{
    public class WebserverConfigApi
    {
        private readonly SdkHttpClient _client;

        public WebserverConfigApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.WebserverBackendSdk.Models.WebserverConfigsListResponse?> WebserverConfigsListAsync()
        {
            return await _client.GetAsync<SDKWork.WebserverBackendSdk.Models.WebserverConfigsListResponse>(ApiPaths.BackendPath("/webserver_configs"));
        }

        /// <summary>
        /// Read one managed configuration file
        /// </summary>
        public async Task<SDKWork.WebserverBackendSdk.Models.WebserverConfigsRetrieveResponse?> WebserverConfigsRetrieveAsync(string configId)
        {
            return await _client.GetAsync<SDKWork.WebserverBackendSdk.Models.WebserverConfigsRetrieveResponse>(ApiPaths.BackendPath($"/webserver_configs/{SerializePathParameter(configId, new PathParameterSpec("configId", "simple", false))}"));
        }

        /// <summary>
        /// Validate and atomically overwrite one managed configuration file
        /// </summary>
        public async Task<SDKWork.WebserverBackendSdk.Models.WebserverConfigsUpdateResponse?> WebserverConfigsUpdateAsync(string configId, SDKWork.WebserverBackendSdk.Models.WebserverConfigWriteRequest body, string idempotencyKey)
        {
            ...
            return await _client.PutAsync<SDKWork.WebserverBackendSdk.Models.WebserverConfigsUpdateResponse>(ApiPaths.BackendPath($"/webserver_configs/{SerializePathParameter(configId, new PathParameterSpec("configId", "simple", false))}"), body, null, requestHeaders, "application/json");
        }
