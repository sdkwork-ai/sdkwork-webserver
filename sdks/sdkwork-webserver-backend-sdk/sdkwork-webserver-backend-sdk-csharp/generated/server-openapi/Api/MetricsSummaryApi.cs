...
namespace SDKWork.WebserverBackendSdk.Api
{
    public class MetricsSummaryApi
    {
        ...
        public MetricsSummaryApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.WebserverBackendSdk.Models.MetricsSummariesRetrieveResponse?> MetricsSummariesRetrieveAsync(string? dateFrom = null, string? dateTo = null)
        {
            ...
            return await _client.GetAsync<SDKWork.WebserverBackendSdk.Models.MetricsSummariesRetrieveResponse>(ApiPaths.AppendQueryString(ApiPaths.BackendPath("/metrics_summaries"), queryString));
        }

        /// <summary>
        /// Retrieve the dashboard metric summary of every tenant
        /// </summary>
        public async Task<SDKWork.WebserverBackendSdk.Models.PlatformMetricsSummariesRetrieveResponse?> PlatformMetricsSummariesRetrieveAsync(string? dateFrom = null, string? dateTo = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("date_from", dateFrom, "form", true, false, null),
            ...
            return await _client.GetAsync<SDKWork.WebserverBackendSdk.Models.PlatformMetricsSummariesRetrieveResponse>(ApiPaths.AppendQueryString(ApiPaths.BackendPath("/platform_metrics_summaries"), queryString));
        }
