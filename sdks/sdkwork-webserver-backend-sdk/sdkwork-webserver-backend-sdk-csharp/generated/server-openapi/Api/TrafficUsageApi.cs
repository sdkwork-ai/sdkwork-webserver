...
namespace SDKWork.WebserverBackendSdk.Api
{
    public class TrafficUsageApi
    {
        ...
        public TrafficUsageApi(SdkHttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<SDKWork.WebserverBackendSdk.Models.TrafficUsagesRetrieveResponse?> TrafficUsagesRetrieveAsync(string? dateFrom = null, string? dateTo = null, string? dimension = null, int? topApps = null)
        {
            ...
            return await _client.GetAsync<SDKWork.WebserverBackendSdk.Models.TrafficUsagesRetrieveResponse>(ApiPaths.AppendQueryString(ApiPaths.BackendPath("/traffic_usage"), queryString));
        }

        /// <summary>
        /// Retrieve aggregated traffic usage of every tenant
        /// </summary>
        public async Task<SDKWork.WebserverBackendSdk.Models.PlatformTrafficUsagesRetrieveResponse?> PlatformTrafficUsagesRetrieveAsync(string? dateFrom = null, string? dateTo = null, string? dimension = null, int? topApps = null)
        {
            var queryString = BuildQueryString(new[]
            {
                new QueryParameterSpec("date_from", dateFrom, "form", true, false, null),
            ...
            return await _client.GetAsync<SDKWork.WebserverBackendSdk.Models.PlatformTrafficUsagesRetrieveResponse>(ApiPaths.AppendQueryString(ApiPaths.BackendPath("/platform_traffic_usage"), queryString));
        }
