...
public class MetricsSummaryApi {
    ...
    public MetricsSummaryApi(HttpClient client) {
        this.client = client;
    }

    /** Retrieve the dashboard metric summary of the caller's own tenant */
    public MetricsSummariesRetrieveResponse metricsSummariesRetrieve(String dateFrom, String dateTo) throws Exception {
        ...
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/metrics_summaries"), query));
        return client.convertValue(raw, new TypeReference<MetricsSummariesRetrieveResponse>() {});
    }

    /** Retrieve the dashboard metric summary of every tenant */
    public PlatformMetricsSummariesRetrieveResponse platformMetricsSummariesRetrieve(String dateFrom, String dateTo) throws Exception {
        String query = buildQueryString(List.of(
            new QueryParameterSpec("date_from", dateFrom, "form", true, false, null),
            new QueryParameterSpec("date_to", dateTo, "form", true, false, null)
        ));
        Object raw = client.get(ApiPaths.appendQueryString(ApiPaths.backendPath("/platform_metrics_summaries"), query));
        return client.convertValue(raw, new TypeReference<PlatformMetricsSummariesRetrieveResponse>() {});
    }
