...
impl ApplicationApi {
    ...
    pub async fn applications_list(&self, page: Option<i64>, page_size: Option<i64>, application_type: Option<&str>, site_type: Option<i64>, status: Option<i64>, q: Option<&str>) -> Result<serde_json::Value, SdkworkError> {
