...
impl RuntimeApi {
    ...
    pub async fn assignments_update(&self, node_uuid: &str, environment: &str, body: &PublishRuntimeAssignmentRequest, idempotency_key: &str) -> Result<RuntimeAssignment, SdkworkError> {
    ...
    pub async fn assignments_observations_create(&self, snapshot_uuid: &str, body: &CreateRuntimeObservationRequest, idempotency_key: &str) -> Result<RuntimeObservation, SdkworkError> {
