...
```bash
npm install @sdkwork/webserver-internal-sdk
# or
yarn add @sdkwork/webserver-internal-sdk
# or
pnpm add @sdkwork/webserver-internal-sdk
```

## Quick Start

```typescript
import { SdkworkCustomClient } from '@sdkwork/webserver-internal-sdk';
