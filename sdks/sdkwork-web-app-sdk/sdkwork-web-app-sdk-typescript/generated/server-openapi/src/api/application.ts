...
/** 更新应用 */
  async update(applicationId: string | number, body: UpdateApplicationRequest, params: ApplicationUpdateParams, requestOptions?: ApiRequestOptions): Promise<ApplicationResponse> {
    const requestHeaders = buildRequestHeaders(
      {
        'Idempotency-Key': { value: params.idempotencyKey, style: 'simple', explode: false },
      },
