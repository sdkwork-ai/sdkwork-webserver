...
public class ApplicationApi {
    ...
    /// 获取应用列表
    public func applicationsList(page: Int? = nil, pageSize: Int? = nil, status: Int? = nil, applicationType: String? = nil, siteType: Int? = nil, keyword: String? = nil) async throws -> ApplicationsListResponse? {
        ...
        return try await client.get(ApiPaths.appendQueryString(ApiPaths.appPath("/applications"), query), responseType: ApplicationsListResponse.self)
    }
    ...
    public func applicationsCreate(body: CreateApplicationRequest, idempotencyKey: String) async throws -> ApplicationsCreateResponse201? {
        ...
        return try await client.post(ApiPaths.appPath("/applications"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: ApplicationsCreateResponse201.self)
    }

    /// 获取应用详情
    public func applicationsRetrieve(applicationId: String) async throws -> ApplicationsRetrieveResponse? {
        return try await client.get(ApiPaths.appPath("/applications/\(serializePathParameter(applicationId, PathParameterSpec(name: "applicationId", style: "simple", explode: false)))"), responseType: ApplicationsRetrieveResponse.self)
    }
    ...
    public func applicationsUpdate(applicationId: String, body: UpdateApplicationRequest, idempotencyKey: String) async throws -> ApplicationsUpdateResponse? {
        ...
        return try await client.patch(ApiPaths.appPath("/applications/\(serializePathParameter(applicationId, PathParameterSpec(name: "applicationId", style: "simple", explode: false)))"), body: body, params: nil, headers: requestHeaders, contentType: "application/json", responseType: ApplicationsUpdateResponse.self)
    }

    /// 删除应用
    public func applicationsDelete(applicationId: String) async throws -> Void {
        _ = try await client.delete(ApiPaths.appPath("/applications/\(serializePathParameter(applicationId, PathParameterSpec(name: "applicationId", style: "simple", explode: false)))"))
    }

    /// 激活应用
    public func applicationsActivate(applicationId: String) async throws -> ApplicationsActivateResponse? {
        return try await client.post(ApiPaths.appPath("/applications/\(serializePathParameter(applicationId, PathParameterSpec(name: "applicationId", style: "simple", explode: false)))/activate"), body: nil, responseType: ApplicationsActivateResponse.self)
    }
