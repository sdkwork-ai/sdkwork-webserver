...
public class ApplicationApi {
    ...
    public ApplicationsCreateResponse201 applicationsCreate(CreateApplicationRequest body, String idempotencyKey) throws Exception {
        ...
        Object raw = client.post(ApiPaths.appPath("/applications"), body, null, requestHeaders, "application/json");
    ...
    public ApplicationsRetrieveResponse applicationsRetrieve(String applicationId) throws Exception {
        Object raw = client.get(ApiPaths.appPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + ""));
    ...
    public ApplicationsUpdateResponse applicationsUpdate(String applicationId, UpdateApplicationRequest body, String idempotencyKey) throws Exception {
        ...
        Object raw = client.patch(ApiPaths.appPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + ""), body, null, requestHeaders, "application/json");
    ...
    public Void applicationsDelete(String applicationId) throws Exception {
        client.delete(ApiPaths.appPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + ""));
        return null;
    }

    /** 激活应用 */
    public ApplicationsActivateResponse applicationsActivate(String applicationId) throws Exception {
        Object raw = client.post(ApiPaths.appPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + "/activate"), null);
    ...
    public ApplicationsPauseResponse applicationsPause(String applicationId) throws Exception {
        Object raw = client.post(ApiPaths.appPath("/applications/" + serializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false)) + "/pause"), null);
