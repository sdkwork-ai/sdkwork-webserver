...
// 获取应用列表
func (a *ApplicationApi) ApplicationsList(page *int, pageSize *int, status *int, applicationType *string, siteType *int, keyword *string) (sdktypes.ApplicationsListResponse, error) {
    ...
    raw, err := a.client.Get(AppendQueryString(AppApiPath("/applications"), query), nil, nil)
    if err != nil {
...
func (a *ApplicationApi) ApplicationsCreate(body sdktypes.CreateApplicationRequest, idempotencyKey string) (sdktypes.ApplicationsCreateResponse201, error) {
    ...
    raw, err := a.client.Post(AppApiPath("/applications"), body, nil, headers, "application/json")
    if err != nil {
...
func (a *ApplicationApi) ApplicationsRetrieve(applicationId string) (sdktypes.ApplicationsRetrieveResponse, error) {
    raw, err := a.client.Get(AppApiPath(fmt.Sprintf("/applications/%s", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
...
func (a *ApplicationApi) ApplicationsUpdate(applicationId string, body sdktypes.UpdateApplicationRequest, idempotencyKey string) (sdktypes.ApplicationsUpdateResponse, error) {
    ...
    raw, err := a.client.Patch(AppApiPath(fmt.Sprintf("/applications/%s", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), body, nil, headers, "application/json")
    if err != nil {
...
func (a *ApplicationApi) ApplicationsDelete(applicationId string) (struct{}, error) {
    raw, err := a.client.Delete(AppApiPath(fmt.Sprintf("/applications/%s", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), nil, nil)
    if err != nil {
        var zero struct{}
        return zero, err
    }
...
func (a *ApplicationApi) ApplicationsActivate(applicationId string) (sdktypes.ApplicationsActivateResponse, error) {
    raw, err := a.client.Post(AppApiPath(fmt.Sprintf("/applications/%s/activate", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), nil, nil, nil, "")
    if err != nil {
...
func (a *ApplicationApi) ApplicationsPause(applicationId string) (sdktypes.ApplicationsPauseResponse, error) {
    raw, err := a.client.Post(AppApiPath(fmt.Sprintf("/applications/%s/pause", SerializePathParameter(applicationId, PathParameterSpec{Name: "applicationId", Style: "simple", Explode: false}))), nil, nil, nil, "")
    if err != nil {
