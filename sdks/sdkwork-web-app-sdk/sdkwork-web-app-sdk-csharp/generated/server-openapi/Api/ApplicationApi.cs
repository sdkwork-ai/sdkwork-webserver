...
namespace SDKWork.Web.AppSdk.Api
{
    public class ApplicationApi
    {
        ...
        /// 获取应用列表
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.ApplicationsListResponse?> ApplicationsListAsync(int? page = null, int? pageSize = null, int? status = null, string? applicationType = null, int? siteType = null, string? keyword = null)
        {
            ...
            return await _client.GetAsync<SDKWork.Web.AppSdk.Models.ApplicationsListResponse>(ApiPaths.AppendQueryString(ApiPaths.AppPath("/applications"), queryString));
        }

        /// <summary>
        /// 创建应用
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.ApplicationsCreateResponse201?> ApplicationsCreateAsync(SDKWork.Web.AppSdk.Models.CreateApplicationRequest body, string idempotencyKey)
        {
            ...
            return await _client.PostAsync<SDKWork.Web.AppSdk.Models.ApplicationsCreateResponse201>(ApiPaths.AppPath("/applications"), body, null, requestHeaders, "application/json");
        }

        /// <summary>
        /// 获取应用详情
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.ApplicationsRetrieveResponse?> ApplicationsRetrieveAsync(string applicationId)
        {
            return await _client.GetAsync<SDKWork.Web.AppSdk.Models.ApplicationsRetrieveResponse>(ApiPaths.AppPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}"));
        }

        /// <summary>
        /// 更新应用
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.ApplicationsUpdateResponse?> ApplicationsUpdateAsync(string applicationId, SDKWork.Web.AppSdk.Models.UpdateApplicationRequest body, string idempotencyKey)
        {
            var requestHeaders = BuildRequestHeaders(
                new Dictionary<string, HeaderParameterSpec>
                {
            ...
            return await _client.PatchAsync<SDKWork.Web.AppSdk.Models.ApplicationsUpdateResponse>(ApiPaths.AppPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}"), body, null, requestHeaders, "application/json");
        }
        ...
        {
            await _client.DeleteAsync<object>(ApiPaths.AppPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}"));
        }

        /// <summary>
        /// 激活应用
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.ApplicationsActivateResponse?> ApplicationsActivateAsync(string applicationId)
        {
            return await _client.PostAsync<SDKWork.Web.AppSdk.Models.ApplicationsActivateResponse>(ApiPaths.AppPath($"/applications/{SerializePathParameter(applicationId, new PathParameterSpec("applicationId", "simple", false))}/activate"), null);
        }

        /// <summary>
        /// 暂停应用
        /// </summary>
        public async Task<SDKWork.Web.AppSdk.Models.ApplicationsPauseResponse?> ApplicationsPauseAsync(string applicationId)
        {
