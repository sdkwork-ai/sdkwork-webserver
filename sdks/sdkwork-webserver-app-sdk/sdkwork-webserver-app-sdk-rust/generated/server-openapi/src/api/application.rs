...
impl ApplicationApi {
    ...
    pub async fn applications_create(&self, body: &CreateApplicationRequest, idempotency_key: &str) -> Result<ApplicationResponse, SdkworkError> {
        let path = app_path(&"/applications".to_string());
    ...
    pub async fn applications_retrieve(&self, application_id: &str) -> Result<ApplicationResponse, SdkworkError> {
        let path = app_path(&format!("/applications/{}", serialize_path_parameter(application_id, PathParameterSpec::new("applicationId", "simple", false))));
        self.client.get(&path, None, None).await
    }
    ...
    pub async fn applications_activate(&self, application_id: &str) -> Result<ApplicationResponse, SdkworkError> {
        let path = app_path(&format!("/applications/{}/activate", serialize_path_parameter(application_id, PathParameterSpec::new("applicationId", "simple", false))));
