...
public class ApplicationApi {
    ...
    /// 获取应用列表
    public func applicationsList(page: Int? = nil, pageSize: Int? = nil, status: Int? = nil, applicationType: String? = nil, siteType: Int? = nil, q: String? = nil) async throws -> ApplicationsListResponse? {
