...
public struct ApplicationResponse: Codable {
    ...
    public init(id: String? = nil, name: String? = nil, slug: String? = nil, description: String? = nil, siteId: String? = nil, appKind: String? = nil, siteType: Int? = nil, status: Int? = nil, hasSourceVersion: Bool? = nil, runtimeConfig: [String: Any]? = nil, storeListing: ApplicationStoreListing? = nil, createdAt: String? = nil, updatedAt: String? = nil) {
        self.id = id
        self.name = name
        self.slug = slug
        self.description = description
