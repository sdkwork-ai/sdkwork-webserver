...
class ApplicationApi {
  ...
  Future<ApplicationsCreateResponse201?> applicationsCreate(CreateApplicationRequest body, String idempotencyKey) async {
    ...
    final response = await _client.post(ApiPaths.appPath('/applications'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<ApplicationsRetrieveResponse?> applicationsRetrieve(String applicationId) async {
    final response = await _client.get(ApiPaths.appPath('/applications/${serializePathParameter(applicationId, const PathParameterSpec('applicationId', 'simple', false))}'));
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<ApplicationsUpdateResponse?> applicationsUpdate(String applicationId, UpdateApplicationRequest body, String idempotencyKey) async {
    ...
    final payload = body.toJson();
    final response = await _client.patch(ApiPaths.appPath('/applications/${serializePathParameter(applicationId, const PathParameterSpec('applicationId', 'simple', false))}'), body: payload, headers: requestHeaders, contentType: 'application/json');
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<void> applicationsDelete(String applicationId) async {
    await _client.delete(ApiPaths.appPath('/applications/${serializePathParameter(applicationId, const PathParameterSpec('applicationId', 'simple', false))}'));
  }

  /// 激活应用
  Future<ApplicationsActivateResponse?> applicationsActivate(String applicationId) async {
    final response = await _client.post(ApiPaths.appPath('/applications/${serializePathParameter(applicationId, const PathParameterSpec('applicationId', 'simple', false))}/activate'));
    return (() {
      final map = sdkworkResponseAsMap(response);
  ...
  Future<ApplicationsPauseResponse?> applicationsPause(String applicationId) async {
    final response = await _client.post(ApiPaths.appPath('/applications/${serializePathParameter(applicationId, const PathParameterSpec('applicationId', 'simple', false))}/pause'));
    return (() {
      final map = sdkworkResponseAsMap(response);
