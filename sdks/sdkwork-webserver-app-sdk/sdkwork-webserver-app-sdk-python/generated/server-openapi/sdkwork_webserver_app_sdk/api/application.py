...
class ApplicationApi:
    ...
    def create(self, body: CreateApplicationRequest, idempotency_key: str) -> ApplicationsCreateResponse201:
        ...
        return self._client.post(f"/app/v3/api/applications", json=body, headers=request_headers)

    def retrieve(self, application_id: str) -> ApplicationsRetrieveResponse:
        """获取应用详情"""
        return self._client.get(f"/app/v3/api/applications/{serialize_path_parameter(application_id, {'name': 'applicationId', 'style': 'simple', 'explode': False})}")
    ...
    def update(self, application_id: str, body: UpdateApplicationRequest, idempotency_key: str) -> ApplicationsUpdateResponse:
        ...
        return self._client.patch(f"/app/v3/api/applications/{serialize_path_parameter(application_id, {'name': 'applicationId', 'style': 'simple', 'explode': False})}", json=body, headers=request_headers)

    def delete(self, application_id: str) -> None:
        """删除应用"""
        return self._client.delete(f"/app/v3/api/applications/{serialize_path_parameter(application_id, {'name': 'applicationId', 'style': 'simple', 'explode': False})}")

    def create_activate(self, application_id: str) -> ApplicationsActivateResponse:
        """激活应用"""
        return self._client.post(f"/app/v3/api/applications/{serialize_path_parameter(application_id, {'name': 'applicationId', 'style': 'simple', 'explode': False})}/activate")
