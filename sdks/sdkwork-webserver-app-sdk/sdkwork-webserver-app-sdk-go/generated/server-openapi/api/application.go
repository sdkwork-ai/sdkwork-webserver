...
// 获取应用列表
func (a *ApplicationApi) ApplicationsList(page *int, pageSize *int, status *int, applicationType *string, siteType *int, q *string) (sdktypes.ApplicationsListResponse, error) {
