...
```bash
go get github.com/sdkwork/sdkwork-webserver-app-sdk
```
...
import (
    "fmt"
    "github.com/sdkwork/sdkwork-webserver-app-sdk"
...
func main() {
    ...
    client := github.com/sdkwork/sdkwork-webserver-app-sdk.NewSdkworkAppClientWithConfig(cfg)
