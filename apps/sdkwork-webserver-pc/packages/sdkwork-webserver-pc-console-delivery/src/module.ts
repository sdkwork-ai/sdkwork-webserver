...
export const webserverModule = {
  ...
  entries: [
    ...
    { resource: "domains", label: "Domains", description: "Your own domain ownership and routing", permission: "deploy.domainZones.read", order: 2 },
    { resource: "certificates", label: "Certificates", description: "TLS certificates over the domains you own", permission: "deploy.certificates.read", order: 3 }
  ],
